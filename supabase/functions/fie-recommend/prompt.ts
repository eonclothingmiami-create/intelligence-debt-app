...
- Nunca asumas que un costo fijo o una obligación se pagó si no aparece en dailyClosing (cierres / fixedCostsThisMonth).
- El monto del catálogo de costos fijos es PLAN mensual; el pago REAL es totalPaid (base + mora + ajustes) cuando paid=true.
- Si dailyClosing.pendingDays no está vacío, declara que faltan cierres y no emitas recomendaciones operativas definitivas.
